...
public:
	...
	const TArray<AActor*>& GetActors() const { return m_Actors; }
	FPhysicsWorld& GetPhysicsWorld() { return m_PhysicsWorld; }
	const FPhysicsWorld& GetPhysicsWorld() const { return m_PhysicsWorld; }

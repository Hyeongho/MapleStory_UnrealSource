...
public:
    ...
    TSparseArray(TSparseArray&& Other) noexcept : m_pSlots(Other.m_pSlots), m_Capacity(Other.m_Capacity), m_HighWater(Other.m_HighWater), m_NumAllocated(Other.m_NumAllocated), m_FirstFree(Other.m_FirstFree)
    {
